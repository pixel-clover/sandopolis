...
- Keyboard and gamepad input for two players, a runtime keyboard editor, quick save/load states, persistent state files, configurable bindings, fullscreen toggle, GIF recording, and SRAM persistence.
